...
test.describe("Brand Sidebar Background Upload (T047)", () => {
  ...
  test("uploads background from brand sidebar and shows in selector", async ({ page }) => {
    const email = `brand-bg-${Date.now()}@example.com`;
