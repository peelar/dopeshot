...
>(({ className, ...props }, ref) => (
  <SheetPrimitive.Overlay
    className={cn(
      "fixed inset-0 z-50 bg-black/60 transition-opacity duration-200 data-[state=closed]:opacity-0 data-[state=open]:opacity-100 data-[state=open]:animate-sheet-overlay-show data-[state=closed]:animate-sheet-overlay-hide",
      className,
    )}
    {...props}
    ref={ref}
...
const sheetVariants = cva(
  "fixed z-50 gap-4 bg-white p-6 shadow-lg outline-none transition-transform duration-300 dark:bg-slate-950 will-change-transform",
  {
    variants: {
      side: {
        top: "inset-x-0 top-0 border-b data-[state=open]:animate-sheet-slide-up data-[state=closed]:animate-sheet-slide-down",
        bottom:
          "inset-x-0 bottom-0 border-t data-[state=open]:animate-sheet-slide-up-bottom data-[state=closed]:animate-sheet-slide-down-bottom",
