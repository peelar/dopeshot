...
export const TEMPLATES: Template[] = [
  // ... existing templates
  {
    ...
    variants: ["left", "right"], // Define supported variants
    createConfig: () => ({
...
Once registered, the template will automatically appear in the `TemplateSelector` component in the UI. You can select it to preview and configure it.
